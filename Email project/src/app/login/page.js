...
export default function Login() {
  ...
  return (
    <div className="flex flex-col items-center justify-center py-20 h-screen md:h-auto dark:bg-black bg-white relative w-full">
      ...
      <div className="max-w-7xl mx-auto my-44 w-full relative overflow-hidden h-full md:h-[40rem] px-4">
        <motion.div
          initial={{
            opacity: 0,
            y: 20
        ...
        >
          ...
          We know it's unusual that our app is requesting many permissions, Google still hasn't verified us. We don't store your emails. Feel free to check out our GitHub repository. Have fun using it, and don't forget to share it. :)
          </p>
        </motion.div>
